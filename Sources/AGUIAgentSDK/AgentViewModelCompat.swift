...
/// Combine-compatible view model for AG-UI agent conversations.
///
/// `AgentViewModelCompat` bridges the AG-UI event stream to SwiftUI on iOS 16 and
/// macOS 13 (and later) via `ObservableObject` / `@Published`. For iOS 17+ and
