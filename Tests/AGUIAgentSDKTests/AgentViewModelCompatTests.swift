...
@MainActor
final class AgentViewModelCompatTests: XCTestCase {

    private var mock: MockChatAgent!
    private var sut: AgentViewModelCompat!

    override func setUp() {
        super.setUp()
        mock = MockChatAgent()
        sut = AgentViewModelCompat(agent: mock, threadId: "test-thread")
    }
